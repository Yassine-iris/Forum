    <?php
        ...
        foreach($posts as $post)
        {
            ...
            <?php
                ...
                {
                ?>
                    <a href='index.php?p=posts&edit=<?= $post[' class='btn btn-success'>Modifier</a>
                    <a href='index.php?p=posts&delete=<?= $post[' class='btn btn-warning' onclick="return(confirm('Etes-vous sûr de vouloir supprimer cet article?'));">Supprimer</a>
                <?php
                }
        }
